...
export async function DELETE(req: NextRequest, context: any) {
  // The storage adapter applies hidden_at guards in the write statement
  // itself. Keeping the guard there closes the moderation race that a
  // read-then-forward wrapper cannot close.
