...
// Admin-only legacy pricing page. The public pricing page is now the
// new design at /pricing; this older version stays reachable for admins
// only. It reads the session to gate access, so it must render
// dynamically (no ISR / static caching).
...
export default async function DirectoryPricingPage({
  ...
  // Admin-only gate — non-admins (and signed-out visitors) are sent home.
